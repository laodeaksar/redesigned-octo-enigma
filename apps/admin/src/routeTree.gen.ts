...
import { Route as AdminVouchersIndexRouteImport } from './routes/_admin/vouchers/index'
...
const AdminVouchersIndexRoute = AdminVouchersIndexRouteImport.update({
  id: '/vouchers/',
  path: '/vouchers/',
  getParentRoute: () => AdminRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_admin/vouchers/': {
      ...
      path: '/vouchers'
      fullPath: '/vouchers/'
      preLoaderRoute: typeof AdminVouchersIndexRouteImport
      parentRoute: typeof AdminRoute
    }
    '/_admin/users/': {
      id: '/_admin/users/'
