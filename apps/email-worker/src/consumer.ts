...
const BINDINGS: WorkerBinding[] = [
  { queue: QUEUES.EMAIL_WELCOME,            processor: handleWelcomeEmail,            options: DEFAULT_WORKER_OPTS },
  { queue: QUEUES.EMAIL_ORDER_CONFIRMATION, processor: handleOrderConfirmationEmail,   options: DEFAULT_WORKER_OPTS },
