        ...
        <Section title="Alamat Pengiriman">
          {addresses.length === 0 ? (
            <div className="rounded-lg border-2 border-dashed border-gray-200 p-6 text-center">
              ...
              <p className="text-sm font-medium text-gray-600 mb-1">Belum ada alamat pengiriman</p>
              <p className="text-xs text-gray-400 mb-4">Tambahkan alamat terlebih dahulu agar kamu bisa melanjutkan checkout</p>
              <a
                href="/profile/addresses"
                className="inline-flex items-center gap-1.5 rounded-lg bg-gray-900 px-4 py-2 text-sm font-semibold text-white hover:opacity-90 transition-opacity"
              >
            ...
            <>
              ...
              <a
                href="/profile/addresses"
                className="flex items-center gap-1.5 text-xs font-medium text-gray-500 hover:text-gray-800 transition-colors mt-1"
              >
